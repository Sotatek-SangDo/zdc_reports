...
<nav>
	<div class="nav-wrapper">
		...
		<ul id='nav-mobile' class='right hide-on-med-and-down nav-right'>
			<a href='#!'>
				<span class='label suite-start-time'>Apr 24, 2018, 10:28:34 AM</span>
			</a>
			<a href='#!'>
			...
			<ul id='test-collection' class='test-collection'>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='1'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 10:29:01 AM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 10:29:01 AM</span>
	<span class='label end-time'>Apr 24, 2018, 10:29:44 AM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 43s+43ms</span>
</div>
		...
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					...
					<td class='timestamp'>10:29:44 AM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='2'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 10:29:46 AM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 10:29:46 AM</span>
	<span class='label end-time'>Apr 24, 2018, 10:30:06 AM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 20s+132ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>iPhone7</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>10:30:06 AM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='3'>
					<div class='test-heading'>
						<span class='test-name'>TestCase_1_2_2</span>
						<span class='test-time'>Apr 24, 2018, 10:30:06 AM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 10:30:06 AM</span>
	<span class='label end-time'>Apr 24, 2018, 10:30:43 AM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 36s+970ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>iPhone7</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>10:30:43 AM</td>
					<td class='step-details'>TestCase_1_2_2</td>
				</tr>
			</tbody>
		</table>
	</div>
							<ul class='screenshots'>
								<li><img data-featherlight='images/TestCase_1_2_2.png' width='10%' src='' data-src='images/TestCase_1_2_2.png'></li>
							</ul>
					</div>
				</li>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='4'>
					<div class='test-heading'>
						<span class='test-name'>TestCase_1_2_3</span>
						<span class='test-time'>Apr 24, 2018, 10:30:44 AM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 10:30:44 AM</span>
	<span class='label end-time'>Apr 24, 2018, 10:31:02 AM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 18s+435ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>iPhone7</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>10:31:02 AM</td>
					<td class='step-details'>TestCase_1_2_3</td>
				</tr>
			</tbody>
		</table>
	</div>
							<ul class='screenshots'>
								<li><img data-featherlight='images/TestCase_1_2_3.png' width='10%' src='' data-src='images/TestCase_1_2_3.png'></li>
							</ul>
					</div>
				</li>
			</ul>
	...
	<div id='charts-row' class='row nm-v nm-h'>
		<div class='col s12 m6 l6 np-h'>
			<div class='card-panel nm-v'>
				...
				<div class='block text-small'>
					<span><span class='strong'>4</span> test(s) passed</span>
				</div>
				<div class='block text-small'>
		...
		<div class='col s12 m6 l6 np-h'>
			<div class='card-panel nm-v'>
				...
				<div class='block text-small'>
					<span><span class='strong'>4</span> step(s) passed</span>
				</div>
				<div class='block text-small'>
					...
					<div class='category-content hide'>
						...
						<div class='category-tests'>
							<table class='bordered table-results'>
								...
								<tbody>
									<tr>
										<td>Apr 24, 2018, 10:29:01 AM</td>
										<td class='linked' test-id='1'>TestCase_1_1_1</td>
										<td><span class='test-status pass'>pass</span></td>
									</tr>
									<tr>
										<td>Apr 24, 2018, 10:29:46 AM</td>
										<td class='linked' test-id='2'>TestCase_1_1_2</td>
										<td><span class='test-status pass'>pass</span></td>
									</tr>
									<tr>
										<td>Apr 24, 2018, 10:30:06 AM</td>
										<td class='linked' test-id='3'>TestCase_1_2_2</td>
										<td><span class='test-status pass'>pass</span></td>
									</tr>
									<tr>
										<td>Apr 24, 2018, 10:30:44 AM</td>
										<td class='linked' test-id='4'>TestCase_1_2_3</td>
										<td><span class='test-status pass'>pass</span></td>
									</tr>
								</tbody>
							</table>
	...
	<div class='card-panel transparent np-v'>
		...
		<div class='row'>
			...
			<div class='col s2'>
				<div class='card-panel r'>
					Start
					<div class='panel-lead'>Apr 24, 2018, 10:28:34 AM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
			 		End
			 		<div class='panel-lead'>Apr 24, 2018, 10:31:03 AM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
					Time Taken
					<div class='panel-lead'>148,831ms</div>
				</div>
			</div>
			<div class='col s4'>
