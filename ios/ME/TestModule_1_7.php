...
<nav>
	<div class="nav-wrapper">
		...
		<ul id='nav-mobile' class='right hide-on-med-and-down nav-right'>
			<a href='#!'>
				<span class='label suite-start-time'>Apr 24, 2018, 2:02:38 PM</span>
			</a>
			<a href='#!'>
			...
			<ul id='test-collection' class='test-collection'>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='1'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 2:02:58 PM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 2:02:58 PM</span>
	<span class='label end-time'>Apr 24, 2018, 2:03:41 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 42s+703ms</span>
</div>
		...
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					...
					<td class='timestamp'>2:03:41 PM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='2'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 2:03:42 PM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 2:03:42 PM</span>
	<span class='label end-time'>Apr 24, 2018, 2:04:02 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 20s+215ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>iPhone7</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>2:04:02 PM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='3'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 2:04:03 PM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 2:04:03 PM</span>
	<span class='label end-time'>Apr 24, 2018, 2:04:39 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 35s+968ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>iPhone7</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>2:04:39 PM</td>
	...
	<div class='card-panel transparent np-v'>
		...
		<div class='row'>
			...
			<div class='col s2'>
				<div class='card-panel r'>
					Start
					<div class='panel-lead'>Apr 24, 2018, 2:02:38 PM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
			 		End
			 		<div class='panel-lead'>Apr 24, 2018, 2:04:39 PM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
					Time Taken
					<div class='panel-lead'>121,067ms</div>
				</div>
			</div>
			<div class='col s4'>
