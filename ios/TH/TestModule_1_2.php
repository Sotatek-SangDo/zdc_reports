...
<nav>
	<div class="nav-wrapper">
		...
		<ul id='nav-mobile' class='right hide-on-med-and-down nav-right'>
			<a href='#!'>
				<span class='label suite-start-time'>Apr 24, 2018, 5:50:24 PM</span>
			</a>
			<a href='#!'>
			...
			<ul id='test-collection' class='test-collection'>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='1'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 5:51:00 PM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 5:51:00 PM</span>
	<span class='label end-time'>Apr 24, 2018, 5:51:53 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 52s+854ms</span>
</div>
		...
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					...
					<td class='timestamp'>5:51:53 PM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='2'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 5:51:53 PM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 5:51:53 PM</span>
	<span class='label end-time'>Apr 24, 2018, 5:52:03 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 9s+210ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>iPhone7</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>5:52:03 PM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='3'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 5:52:03 PM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 5:52:03 PM</span>
	<span class='label end-time'>Apr 24, 2018, 5:52:40 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 36s+414ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>iPhone7</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>5:52:40 PM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='4'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 24, 2018, 5:52:40 PM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 24, 2018, 5:52:40 PM</span>
	<span class='label end-time'>Apr 24, 2018, 5:52:54 PM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 13s+349ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>iPhone7</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>5:52:54 PM</td>
	...
	<div class='card-panel transparent np-v'>
		...
		<div class='row'>
			...
			<div class='col s2'>
				<div class='card-panel r'>
					Start
					<div class='panel-lead'>Apr 24, 2018, 5:50:24 PM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
			 		End
			 		<div class='panel-lead'>Apr 24, 2018, 5:52:54 PM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
					Time Taken
					<div class='panel-lead'>149,755ms</div>
				</div>
			</div>
			<div class='col s4'>
