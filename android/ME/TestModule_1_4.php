...
<nav>
	<div class="nav-wrapper">
		...
		<ul id='nav-mobile' class='right hide-on-med-and-down nav-right'>
			<a href='#!'>
				<span class='label suite-start-time'>Apr 27, 2018 10:46:25 AM</span>
			</a>
			<a href='#!'>
			...
			<ul id='test-collection' class='test-collection'>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='1'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 27, 2018 10:46:45 AM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 27, 2018 10:46:45 AM</span>
	<span class='label end-time'>Apr 27, 2018 10:47:40 AM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 55s+86ms</span>
</div>
		...
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					...
					<td class='timestamp'>10:47:40 AM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='2'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 27, 2018 10:47:44 AM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 27, 2018 10:47:44 AM</span>
	<span class='label end-time'>Apr 27, 2018 10:47:57 AM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 12s+755ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>GalaxyS5</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>10:47:57 AM</td>
				...
				<li class='test displayed active  pass' status='pass' bdd='false' test-id='3'>
					<div class='test-heading'>
						...
						<span class='test-time'>Apr 27, 2018 10:48:03 AM</span>
						<span class='test-status right pass'>pass</span>
					</div>
					<div class='test-content hide'>
<div class='test-time-info'>
	<span class='label start-time'>Apr 27, 2018 10:48:03 AM</span>
	<span class='label end-time'>Apr 27, 2018 10:48:09 AM</span>
	<span class='label time-taken grey lighten-1 white-text'>0h 0m 6s+469ms</span>
</div>
	<div class='test-attributes'>
			<div class='category-list'>
				<span class='category label white-text'>GalaxyS5</span>
	...
	<div class='test-steps'>
		<table class='bordered table-results'>
			...
			<tbody>
				<tr class='log' status='pass'>
					<td class='status pass' title='pass' alt='pass'><i class='material-icons'>check_circle</i></td>
					<td class='timestamp'>10:48:09 AM</td>
	...
	<div class='card-panel transparent np-v'>
		...
		<div class='row'>
			...
			<div class='col s2'>
				<div class='card-panel r'>
					Start
					<div class='panel-lead'>Apr 27, 2018 10:46:25 AM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
			 		End
			 		<div class='panel-lead'>Apr 27, 2018 10:48:14 AM</div>
				</div>
			</div>
			<div class='col s2'>
				<div class='card-panel r'>
					Time Taken
					<div class='panel-lead'>109,166ms</div>
				</div>
			</div>
			<div class='col s4'>
